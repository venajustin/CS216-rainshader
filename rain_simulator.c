 ...
 *
 *   Model: "Bus Stop & Traffic Light" ( https://skfb.ly/oDEpS ) by Ricardo_PG
 *   licensed under Creative Commons Attribution-Commercial
 *
 ********************************************************************************************/
...
//         }
        ...
        DrawModel(car, (Vector3){0.0f, 0.0f, 0.0f}, 0.01, WHITE); // Draw car model
    ...
    // stoplight.materials[0].shader = (Shader){0};
    // UnloadMaterial(stoplight.materials[0]);
    // stoplight.materials[0].maps = NULL;
    // UnloadModel(stoplight);
